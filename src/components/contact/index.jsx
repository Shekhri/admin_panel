...
function Contact() {
   ...
   useEffect(()=> {
      axios.get(`http://localhost:8000/SpecialOffer`)
   ...
   const HandlePost = (e) => {
      ...
      axios.post(`http://localhost:8000/SpecialOffer`, body)
    ...
    const HandleDelete = (e) => {
      e.preventDefault();
      axios.delete(`http://localhost:8000/SpecialOffer/${e.target.value}`)
      axios.get(`http://localhost:8000/SpecialOffer`)
      .then((data) => setData(data))
      setTimeout(() => {
         window.location.reload()
   ...
   return(
      <><div className={styles.conatiner}>
         ...
         <h1 className={styles.h1t}>Chegirmadagi kitoblar</h1>
